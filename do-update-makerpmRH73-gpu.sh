...
DEFAULT_BRANCH="upstream-for-wfr-ifs-rhel7.3"
...
CFLAGS_MODULE += -DUSE_PI_LED_ENABLE=1 -DIFS_RH73
...
hfi1-y := affinity.o chip.o device.o driver.o efivar.o eprom.o \
	...
	verbs_txreq.o diag.o user_exp_rcv_gpu.o user_sdma_gpu.o gpu.o \
