...
declare -A distros=( ["7.4"]="IFS_RH74" ["7.5"]="IFS_RH75" ["7.6"]="IFS_RH76" ["7.7"]="IFS_RH77" ["7.8"]="IFS_RH78" ["8.0"]="IFS_RH80" ["8.1"]="IFS_RH81" ["12.2"]="IFS_SLES12SP2" ["12.3"]="IFS_SLES12SP3" ["12.4"]="IFS_SLES12SP4" ["12.5"]="IFS_SLES12SP5" ["15"]="IFS_SLES15" ["15.1"]="IFS_SLES15SP1" )
declare -A distro_directory=(["7.4"]="RH74" ["7.5"]="RH75" ["7.6"]="RH76" ["7.7"]="RH77" ["7.8"]="RH78" ["8.0"]="RH80" ["8.1"]="RH81" ["12.2"]="SLES12SP2" ["12.3"]="SLES12SP3" ["12.4"]="SLES12SP4" ["12.5"]="SLES12SP5" ["15"]="SLES15" ["15.1"]="SLES15SP1" )
...
if [[ $ID == "rhel" ]]; then
	if [[ $VERSION_ID == "7.8" ]]; then
		ln -s $PWD/distro/RHEL77/ipoib drivers/infiniband/ulp/ipoib
		aipbuild="true"
	fi
	...
	if [[ $VERSION_ID == "8.0" ]]; then
		ln -s $PWD/distro/RHEL80/ipoib drivers/infiniband/ulp/ipoib
		aipbuild="true"
	fi
	if [[ $VERSION_ID == "8.1" ]]; then
		ln -s $PWD/distro/RHEL81/ipoib drivers/infiniband/ulp/ipoib
		aipbuild="true"
	fi
elif [[ $ID == "sles" ]]; then
	...
	if [[ $VERSION_ID == "12.5" ]]; then
		ln -s $PWD/distro/SLES12SP5/ipoib drivers/infiniband/ulp/ipoib
		aipbuild="true"
	fi
	...
	if [[ $VERSION_ID == "15.1" ]]; then
		ln -s $PWD/distro/SLES15SP1/ipoib drivers/infiniband/ulp/ipoib
		aipbuild="true"
	fi
fi
...
if [ $VERSION_ID = '8.0' -o $VERSION_ID = '8.1' ]
then
	qibbuild="false"
fi
...
if [ $VERSION_ID = '15' -o $VERSION_ID = '12.4' -o $VERSION_ID = '12.5' -o $VERSION_ID = '15.1' -o $VERSION_ID = '8.0' -o $VERSION_ID = '8.1' ]
then
